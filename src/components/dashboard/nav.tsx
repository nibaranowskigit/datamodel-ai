...
import { LayoutDashboard, Settings, AlertTriangle, Fingerprint, Table2 } from 'lucide-react';
import { cn } from '@/lib/utils';
import { Badge } from '@/components/ui/badge';

const NAV_ITEMS = [
  { label: 'Dashboard', href: '/dashboard', icon: LayoutDashboard, badgeCount: false as const },
  { label: 'Fields', href: '/data-model/fields', icon: Table2, badgeCount: false as const },
